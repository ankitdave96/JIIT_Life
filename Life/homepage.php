	...
	?>
		...
		<nav>
			<ul id="menu" style="margin-top:-0.5%">
				...
				<li><?php if($log==1){echo "<a href= \"survey2.html\">";} if($log==0) {echo " <a href= \"survey1.html\"> ";} ?><div class="zoom_img" >
					<img src="file-document-clipboard-survey-512.png" height="50" style="margin-left:71%"/></div></a></li>
				<li><?php if($log==1){echo "<a href= \"polls1.html\">";} if($log==0) {echo " <a href= \"polls3.html\"> ";} ?><div class="zoom_img">
